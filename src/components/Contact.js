    ...
    <div className="contact-section">
      ...
      <div className="contact-container">
        ...
        <div className="contact-icons">
          ...
          <a className="cta" id="mail" href="mailto:sanjaydasari.work@gmail.com" target="_blank" rel="noopener noreferrer"><FaEnvelope /></a>
          ...
          <a className="cta" id="tele" href="https://t.me/tink543" target="_blank" rel="noopener noreferrer"><FaTelegram /></a>
        </div>
